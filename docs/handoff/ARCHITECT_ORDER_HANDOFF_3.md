...
The chapter label and title are deliberately blank of any place name. Nothing
on screen may say where the building is before the player has found it.
...
2. With the simulator 800 m away, a compass point and a distance show; at
   300 m the compass is gone and the distance remains; inside 40 m the check
   passes and Continue ticks.
